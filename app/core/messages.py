...
ANALYSIS_RESULTS = (
    ...
    "{comment}\n\n"
    "<blockquote>"
    "Ты получил <b>{final_points} баллов</b>{jackpot_text}{bonus_text} <tg-emoji emoji-id=\"5368646692650395057\">😊</tg-emoji>"
    "</blockquote>"
)
...
# Магазин
SHOP_MAIN = (
    '<a href="https://i.ibb.co/FqjFKYg6/Invite-v1.png">&#8203;</a>' 
    "Привет, это тайный магазин Ути <tg-emoji emoji-id=\"5399854298685285658\">😜</tg-emoji>, здесь ты можешь купить разные бонусы за накопленые баллы!\n\n"
...
# Лимиты
LIMITS_REACHED = (
    "<tg-emoji emoji-id=\"5375182043737002931\">❌</tg-emoji> <b>У вас закончились сканов анализа!</b>\n\n"
    "Новый скан появится через: <b>{time_left}</b>\n"
    "Всего можно накопить до 3 сканов (1 каждые 8 часов)."
)
