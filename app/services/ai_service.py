...
class AIService:
    ...
    def _get_analysis_prompt(self) -> str:
        ...
        7. "food_score": Базовая оценка еды от 1 до 100 (насколько это вкусно/аппетитно выглядит).
        8. "health_multiplier": Оценка полезности от 0.7 до 2.0 (где 2.0 - суперфуд, а 0.7 - вредный фастфуд).
